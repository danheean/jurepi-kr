...
export function RuleList({
  ...
  return (
    <div className="space-y-3">
      ...
      <button
        onClick={onAddRule}
        className="w-full px-4 py-2 bg-brand text-on-brand rounded-lg font-medium text-sm hover:bg-brand-strong transition-colors focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2"
