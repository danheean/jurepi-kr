    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 bg-brand text-on-brand rounded-lg font-medium hover:bg-brand-strong disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand"
        ...
        <button
          ...
          disabled={output.length === 0}
          className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 bg-surface-muted text-text rounded-lg font-medium hover:bg-surface-sunken disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand"
