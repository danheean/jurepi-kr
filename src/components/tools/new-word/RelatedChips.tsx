        ...
        {related.map((slug) => {
          ...
          return (
            <button
              ...
              className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full bg-surface-muted hover:bg-surface-sunken text-sm text-brand transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand"
