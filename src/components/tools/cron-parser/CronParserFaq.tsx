 ...
 * CronParserStructuredData at the route level.
 */
export function CronParserFaq() {
  ...
  return (
    <section
      aria-labelledby="cron-parser-faq-heading"
    ...
    >
      ...
      />
      <h2 id="cron-parser-faq-heading" className="font-display text-3xl font-bold text-text">
        FAQ
      </h2>
