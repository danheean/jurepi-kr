...
slug: martin-fowler
knownFor: |
  'Refactoring' 저자로 코드 개선의 이론을 정립. Agile Manifesto 서명자.
  엔터프라이즈 아키텍처, 도메인 주도 설계, 마이크로서비스의 거장.
  30년 이상 소프트웨어 설계의 최전선에서 활동해온 사상가.
tags:
  - refactoring
  - architecture
  - agile
...
achievements:
  - year: 1996
    title: "『Analysis Patterns: Reusable Object Models』 출판"
  - year: 1999
    title: "\"Refactoring: Improving the Design of Existing Code\" 출판 (리팩토링 운동 시작)"
  - year: 2001
    title: Agile Manifesto 공동 저술 및 서명
  - year: 2002
    title: "\"Patterns of Enterprise Application Architecture\" 출판"
books:
