...
knownFor: |
  ...
  Eclipse JDT 개발 주도, VS Code 개발에 기여. 
  객체지향 설계와 개발 도구 혁신의 선구자.
tags:
  - design-patterns
  - java
  - architecture
...
achievements:
  - year: 1994
    title: "『Design Patterns: Elements of Reusable Object-Oriented Software』 출판 (GoF)"
  - year: 1995
    title: Eclipse JDT(Java Development Tools) 개발 주도
  - year: 2015
    title: VS Code 개발 기여 (Microsoft Zürich lab)
books:
...
links:
  - label: "Wikipedia English"
    url: "https://en.wikipedia.org/wiki/Erich_Gamma"
  - label: "Eclipse 프로젝트"
